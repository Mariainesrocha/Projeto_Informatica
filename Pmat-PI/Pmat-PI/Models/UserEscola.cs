...
{
    public partial class UserEscola
    {
        public UserEscola()
        {
            InverseIdResponsavelNavigation = new HashSet<UserEscola>();
        ...
        public virtual ICollection<UserEscola> InverseIdResponsavelNavigation { get; set; }
