...
{
    public partial class ProvaEqEnunNivel
    {
        public ProvaEqEnunNivel()
        {
            ProvaEqEnunNivelUserResps = new HashSet<ProvaEqEnunNivelUserResp>();
        }
        ...
        public virtual ProvaEquipaEnunciado IdEnunciadoEquipaNavigation { get; set; }
        public virtual ICollection<ProvaEqEnunNivelUserResp> ProvaEqEnunNivelUserResps { get; set; }
    }
}
